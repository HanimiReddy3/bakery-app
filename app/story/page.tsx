      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl space-y-8">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Bakery Delights was founded in 2015 with a simple dream: to bring the finest artisanal baked goods 
        ...
        <section className="bg-orange-50 rounded-2xl p-8 text-center">
          ...
          <Link href="/products" className="inline-block bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 px-8 rounded-lg transition">
            Shop Now
          </Link>
        </section>
      </div>
