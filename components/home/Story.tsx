...
export function Story() {
  return (
    <section className="container mx-auto px-6">
      <div className="bg-neutral-100 rounded-3xl p-12 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-neutral-600 leading-relaxed">
            At Bakery Delights, we believe that the best bread takes time.
            We use century-old sourdough starters, organic stone-ground flour,
            and the purest ingredients.
          </p>

          <div className="flex gap-10 text-orange-500 font-semibold">
            <div>
